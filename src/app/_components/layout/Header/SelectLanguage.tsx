...
const SelectLanguage = () => {
  ...
  const toggle = () => setIsDropdownOpen((value) => !value);
  ...
  return (
    <div className="flex flex-col relative">
      ...
      <button
        ...
        hover:border-primary-yellow hover:shadow-[0_0_0_1px_#ffcc29] duration-300"
      >
        <span>
      ...
      {isDropdownOpen && (
        <ul
          ref={dropdownRef}
          className="absolute right-0 top-11 bg-dark-gray text-white rounded-lg
        ...
        >
          ...
          <span
            ...
            border-b-dark-gray right-2 -top-[6px]"
          ></span>

          {/* en */}
          <li
            onClick={close}
            className="px-4 flex items-center gap-x-1 cursor-pointer
