...
const Footer = () => {
  ...
  return (
    <footer
      className="mt-20 section-full-w mb-16 responsive-px pb-8 
      py-6 mobileL:py-8 mobileXL:py-10 laptop:py-14 bg-gray-50
    ...
    >
      ...
      <p className="text-center">© 2022 Amatto. All Rights Reserved.</p>
    </footer>
  );
};
